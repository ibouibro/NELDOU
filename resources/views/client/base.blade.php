...
<head>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
     <!--   <form class="form-inline" method="get" action="chercher" >
          ...
          </form> --> <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto"> <li class="nav-item">
            <a class="nav-link" href="a_propos">Qui sommes nous ?</a></div></ul>
          </li>
    ...
    <!--    <div class=""></div>  <li class="nav-item">
            <a class="nav-link" href="{{ route('register') }}">register</a>
          </li>  -->
          <li class="nav-item">
            <a class="nav-link" href="{{ route('login') }}">  <span class="glyphicon glyphicon-user"></span>  se connecter</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <img src="logo.png" style="position:absolute;margin-top:29px;margin-left:82px;"><span  class="glyphicon glyphicon-shopping-cart" style="color:rgba(0,9,200,.7);margin-left:213px;font-size:18px;margin-top:25px;"></span>    <div class="list-group">
