...
$names=null;
        ...
        echo "<script>setTimeout(function(){window.scroll(0, 400);},1000); </script>";
         return view("client/contact")->with(['carousel' => $carousel, 'categories' => $names, 'contact' => $contact ]);
    }
...
return view("client/contact")->with(['carousel' => $carousel, 'categories' => $names ,'ok' => 'votre message a été envoyé']);
