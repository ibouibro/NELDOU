...
class publicationController extends Controller
{
    ...
    {
        Session::put('count',count(DB::table('messages')->where('etat',0)->get()));
...
return view("client/oneItem")->with(['userId' => $user ,'publication' => $objet ,'carousel' => $carousel, 'categories' => $names, 'show' => 1 ,'delai' => $delai ]);
    ...
    public function index()
    {
       ...
       $articles =null;
       $i=0;
       $objets=DB::table('publicaton')->where('user',Auth::id())->get();
    ...
    public function ajouter(Request $request)
     {
       ...
       $idproduit_id=null;
        $idArticle =(int)DB::table('produit')->where('nom',$article)->pluck('id')[0];
    ...
    public function welcome()
    {
        ...
        return view("client/welcome")->with(['carousel' => $carousel, 'publications' => $objets ,'categories' => $names]);
    ...
    public function menuResult(Request $request)
    {
        ...
        return view("client/categorie")->with(['carousel' => $carousel, 'publications' => $objets ,'categories' => $names ,'categori'=> $val ,'count' => count($objets)]);
    ...
    public function result(Request $request)
    {
        ...
        return view("client/result")->with(['carousel' => $carousel, 'publications' => $objets ,'categories' => $names]);
